"""Обучение захвата myCobot 280 PI с RSL-RL (PPO).
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Обучение myCobot 280 PI (RSL-RL PPO)")
    parser.add_argument("--exp_name", type=str, default=None,
                        help="Имя эксперимента (default: MyCobotPickCube_YYYYMMDD_HHMMSS)")
